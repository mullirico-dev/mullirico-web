      ...
      <div className="site-container product-grid">
        <div className="product-visual">
          ...
          <figure className="photo-plate product-detail">
            ...
            />
            <figcaption className="photo-caption">Scored by hand · baked to a deep crust</figcaption>
          </figure>
        </div>
          ...
          <article className="mr-card product-card">
            ...
            <div className="product-card__body">
              ...
              <div className="product-card__copy">
                <p className="product-meta"><span>Net wt.</span>{product.weight}</p>
                <p className="product-meta"><span>Baked in</span>{product.location}</p>
